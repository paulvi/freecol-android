...
public class JEditorPane extends JComponent {
	...
	public JEditorPane(String string, String message) {
		// Does nothing
	}

	public void putClientProperty(String honorDisplayProperties, Boolean true1) {
		// Does nothing
	}
	...
	public void addHyperlinkListener(Component colopediaPanel) {
		// Does nothing
	}
