...
import org.freecolandroid.repackaged.java.awt.datatransfer.UnsupportedFlavorException;
...
import org.freecolandroid.repackaged.javax.swing.ListModel;
import org.freecolandroid.repackaged.javax.swing.ListSelectionModel;
...
public class BuildQueuePanel extends FreeColPanel implements ActionListener, ItemListener {
    ...
    public BuildQueuePanel(FreeColClient freeColClient, GUI gui, Colony colony) {
        ...
        constructionPanel = new ConstructionPanel(freeColClient, gui, colony, false);
